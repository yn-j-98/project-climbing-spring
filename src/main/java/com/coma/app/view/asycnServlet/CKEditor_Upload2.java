...
//			System.out.println("CKEditor_Upload2.java folder_session 로그 : "+update_folder_session);
...
//			System.out.println("CKEditor_Upload2.java 로그 MessageDigest.getInstance(\"MD5\") 생성오류 발생");
//		}
//		//보안코드를 반환해줍니다.
