...
ALTER TABLE BATTLE_RECORD
    ADD CONSTRAINT FK_BATTLE_RECORD_BATTLE_NUM
        FOREIGN KEY (BATTLE_RECORD_BATTLE_NUM) REFERENCES BATTLE(BATTLE_NUM) ON DELETE SET NULL;
...
ALTER TABLE RESERVATION
    ADD CONSTRAINT FK_RESERVATION_MEMBER_ID
        FOREIGN KEY (RESERVATION_MEMBER_ID) REFERENCES MEMBER(MEMBER_ID);

ALTER TABLE BATTLE
    ADD COLUMN BATTLE_STATUS CHAR(1) DEFAULT 'F';
