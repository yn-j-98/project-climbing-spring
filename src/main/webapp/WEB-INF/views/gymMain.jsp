					...
					<div class="card-body">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<!-- 암벽장 리스트 -->
								<c:forEach var="data" items="${gym_datas}">
									<form action="gymInfo.do" id="gym_list">
...
<script>
	...
	document.addEventListener("DOMContentLoaded", function() {
		const _totalCount = ${total};// 서버에서 전달된 전체 게시물 개수
		const currentPage = ${page};// 서버에서 전달된 현재 페이지 번호
