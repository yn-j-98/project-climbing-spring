	...
	<div class="page-inner">
		...
		<div class="row pt-2 pb-5">
			<div class="col-12">
				<div class="d-flex justify-content-center align-items-center">
					<a href="community.do" class="text-dark text-decoration-underline link-primary">
						<h3 class="m-0"><b>전체</b></h3>
					</a>
					<h3 class="px-5 m-0">/</h3>
					<a href="location.do" class="text-dark text-decoration-none link-primary">
						<p class="fs-4 m-0">지역</p>
					</a>
				</div>
			</div>
		</div>
		<div class="row pt-3">
			<div class="col-12 p-0">
				<form action="community.do" method="GET">
					<div class="row">
